...
export const STARSHIP_PROFILE = {
  ...
  milestones: [
    ...
    {
      t: 170, alt: 66, vel: 2200,
      label: 'BOOSTER MECO',
      stage: 'superheavy',
      desc: 'Main Engine Cutoff on the Super Heavy booster. After burning 3,400 tonnes of propellant in under 3 minutes, the booster\'s job is done. The vehicle is now traveling at ~2.2 km/s.',
      short: 'Booster engines shut down at 66 km.',
    },
    {
      t: 173, alt: 68, vel: 2250,
      label: 'HOT-STAGING',
      stage: 'both',
      desc: 'Starship\'s Raptor engines ignite while still attached to the booster — a technique called hot-staging. This minimizes the velocity loss during separation and pushes the booster away.',
      short: 'Ship engines fire while still attached to booster.',
    },
    {
      t: 176, alt: 70, vel: 2300,
      label: 'STAGE SEPARATION',
      stage: 'ship',
      desc: 'The ship separates from the booster. From this point, Starship continues to orbit under its own power while Super Heavy begins its return journey to the launch site.',
      short: 'Ship separates. Booster begins return.',
    },
    {
      t: 181, alt: 72, vel: 2350,
      label: 'BOOSTBACK BURN',
      stage: 'booster-return',
      desc: 'Super Heavy flips around using cold gas thrusters and reignites a subset of its Raptor engines to reverse its trajectory, targeting a return to the launch tower for a catch landing.',
      short: 'Booster flips and burns back toward launch site.',
    },
    {
      t: 300, alt: 120, vel: 5500,
      label: 'ABOVE ATMOSPHERE',
      stage: 'ship',
      desc: 'Starship passes above the sensible atmosphere. Aerodynamic forces are negligible. The vacuum Raptor engines operate at peak efficiency with their larger expansion nozzles.',
      short: 'Vacuum engines at peak efficiency above 100 km.',
    },
    {
      t: 530, alt: 200, vel: 7800,
      label: 'SECO — ORBIT',
      stage: 'orbit',
      desc: 'Ship Engine Cutoff. Starship has reached orbital velocity of approximately 7.8 km/s at 200 km altitude. The vehicle is now in low Earth orbit.',
